...
public class Seminar<T extends IStudent> {
    ...
    private List<T> participants = new ArrayList<>(); //TODO: List of participants
    ...
    public void addParticipant(T participant/*TODO: Parameter*/) {
        participants.add(participant); //TODO: Add to list of participants
    }

    public List<T>/*TODO: Return Type*/ getParticipantsFromStudyProgram(String subject) {

        List<T> matchedParticipants = new ArrayList<>();
